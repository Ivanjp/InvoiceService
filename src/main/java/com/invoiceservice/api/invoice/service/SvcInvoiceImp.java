...
import com.invoiceservice.exceptionHandler.ApiException;
...
public class SvcInvoiceImp implements SvcInvoice {
    ...
    private DtoCustomer getCustomer(Integer customerCode) {
        try {
            ResponseEntity<DtoCustomer> response = restTemplate
                    .getForEntity("http://localhost:8080/customer/" + customerCode, DtoCustomer.class);
    ...
    private DtoProduct getProduct(String productCode) {
        try {
            ResponseEntity<DtoProduct> response = restTemplate
                    .getForEntity("http://localhost:8081/products/" + productCode, DtoProduct.class);
            return response.getBody();
        } catch (Exception e) {
